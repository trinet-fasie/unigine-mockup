...
void Triggers::renderVisualizer()
{
	...
	for (int i = 0; i < trigger.size(); i++)
	{
		...
		v->renderLine3D(p0, p1, color);
		v->renderLine3D(p1, p2, color);
		v->renderLine3D(p2, p3, color);
		v->renderLine3D(p3, p0, color);
		v->renderLine3D(p4, p5, color);
		v->renderLine3D(p5, p6, color);
		v->renderLine3D(p6, p7, color);
		v->renderLine3D(p7, p4, color);
		v->renderLine3D(p0, p4, color);
		v->renderLine3D(p1, p5, color);
		v->renderLine3D(p2, p6, color);
		v->renderLine3D(p3, p7, color);
	}
}
